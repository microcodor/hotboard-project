...
const PLATFORM_CONFIG: Record<string, {
  ...
  'baidu-hot':    { color: 'text-blue-600',  bgColor: 'bg-blue-50',   borderColor: 'border-blue-100',  fallbackIcon: '🔍' },
  'bilibili-hot': { color: 'text-pink-500',  bgColor: 'bg-pink-50',   borderColor: 'border-pink-100',  fallbackIcon: '📺' },
  'weibo-hot':    { color: 'text-orange-500',bgColor: 'bg-orange-50', borderColor: 'border-orange-100',fallbackIcon: '📱' },
  'zhihu-hot':    { color: 'text-blue-500',  bgColor: 'bg-blue-50',   borderColor: 'border-blue-100',  fallbackIcon: '💡' },
  'douyin-hot':   { color: 'text-gray-900',  bgColor: 'bg-gray-50',   borderColor: 'border-gray-200',  fallbackIcon: '🎵' },
  'douban-movie': { color: 'text-green-600', bgColor: 'bg-green-50',  borderColor: 'border-green-100', fallbackIcon: '🎬' },
  'thepaper-hot': { color: 'text-red-600',   bgColor: 'bg-red-50',    borderColor: 'border-red-100',   fallbackIcon: '📰' },
  'hn-hot':       { color: 'text-orange-600',bgColor: 'bg-orange-50', borderColor: 'border-orange-100',fallbackIcon: '⚡' },
  '36kr-hot':     { color: 'text-blue-700',  bgColor: 'bg-blue-50',   borderColor: 'border-blue-100',  fallbackIcon: '💼' },
  'juejin-hot':   { color: 'text-blue-500',  bgColor: 'bg-blue-50',   borderColor: 'border-blue-100',  fallbackIcon: '💎' },
  'toutiao-hot':  { color: 'text-red-500',   bgColor: 'bg-red-50',    borderColor: 'border-red-100',   fallbackIcon: '📡' },
  'sspai-hot':    { color: 'text-red-500',   bgColor: 'bg-red-50',    borderColor: 'border-red-100',   fallbackIcon: '✨' },
  'tencent-hot':  { color: 'text-blue-600',  bgColor: 'bg-blue-50',   borderColor: 'border-blue-100',  fallbackIcon: '📰' },
  'people-hot':   { color: 'text-red-700',   bgColor: 'bg-red-50',    borderColor: 'border-red-100',   fallbackIcon: '🗞️' },
  'xinhua-hot':   { color: 'text-red-600',   bgColor: 'bg-red-50',    borderColor: 'border-red-100',   fallbackIcon: '📡' },
  'v2ex-hot':       { color: 'text-gray-700',  bgColor: 'bg-gray-50',   borderColor: 'border-gray-200',  fallbackIcon: '🌐' },
  'github-trending':{ color: 'text-gray-900',  bgColor: 'bg-gray-50',   borderColor: 'border-gray-200',  fallbackIcon: '🐙' },
  'devto-hot':      { color: 'text-indigo-600',bgColor: 'bg-indigo-50', borderColor: 'border-indigo-100',fallbackIcon: '👩‍💻' },
  'lobsters-hot':   { color: 'text-red-600',   bgColor: 'bg-red-50',    borderColor: 'border-red-100',   fallbackIcon: '🦞' },
  'hn-best':        { color: 'text-orange-600',bgColor: 'bg-orange-50', borderColor: 'border-orange-100',fallbackIcon: '⚡' },
}
